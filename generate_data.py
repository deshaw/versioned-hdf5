...
class TestVersionedDatasetPerformance(TestCase):
    ...
    def _modify_dss_dense(cls, key0_ds, key1_ds, val_ds,
        ...
        if random.randrange(0, 100) <= pct_deletes:
            ...
            arr_val = np.delete(arr_val, rs_0, axis=0)
            ...
            arr_val = np.delete(arr_val, rs_1, axis=1)
            ...
            val_shape = (val_shape[0] - r_num_dels_0, val_shape[1] - r_num_dels_1)
        ...
        if random.randrange(0, 100) <= pct_inserts:
            ...
            arr_val = np.insert(arr_val, rs_0, np.random.rand(rand_num_inss_0, n_key1), axis=0)
            ...
            arr_val = np.insert(arr_val, rs_1, np.random.rand(n_key0, rand_num_inss_1), axis=1)
            ...
            val_shape = (val_shape[0] + rand_num_inss_0, val_shape[1] + rand_num_inss_1)
            val_ds.resize(val_shape)
            val_ds[:] = arr_val
        # append
        rand_num_apps_0 = int(np.random.randn() + num_rows_per_append_0)
